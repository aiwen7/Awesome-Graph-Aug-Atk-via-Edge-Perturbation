...
import numpy as np
import torch
from dgl_dataset import CiteseerGraphDataset, CoraGraphDataset, PubmedGraphDataset
from torch import nn
from torch.nn import functional as F, Parameter
from tqdm import trange
from dagnn_utils import evaluate, generate_random_seeds, set_random_state
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epochs", type=int, default=150, help="Training epochs."
    )
    parser.add_argument(
        "--early-stopping",
        type=int,
